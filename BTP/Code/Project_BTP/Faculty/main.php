                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="Coursesvalidation.php"><i class="menu-icon icon-inbox"></i>Validation Info</a></li>
                                <li><a href="enrolled_courses.php"><i class="menu-icon icon-tasks"></i>Attendence Info</a></li>
                            </ul>
                            <!--/.widget-nav-->
                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="check1.php" class="btn-box big span4"><i class="icon-list-alt"></i>
                                        <p class="text-muted">
                                            Validation</p>
                                    </a>
                                    ...
                                    <a href="#" class="btn-box big span4"><i class="icon-wrench"></i>
                                        <p class="text-muted">
